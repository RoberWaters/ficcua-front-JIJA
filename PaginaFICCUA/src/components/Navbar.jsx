  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50">
      ...
      <nav
        ...
        style={{
          background: scrolled ? "rgba(21,10,36,0.82)" : "rgba(21,10,36,0.28)",
          backdropFilter: "blur(18px)",
          WebkitBackdropFilter: "blur(18px)",
          boxShadow: scrolled ? "0 12px 30px -18px rgba(0,0,0,0.6)" : "none",
          ...
          <div className="hidden items-center gap-1 md:flex">
            {LINKS.map((l) => (
              <a
                ...
                className={`relative rounded-full px-4 py-2 text-sm font-semibold transition-colors duration-200 hover:text-ficcua-gold ${
            ...
            <Button href="#cronogramas" size="sm" className="ml-2">
              Ver programación
            </Button>
          </div>
